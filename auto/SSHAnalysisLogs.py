...
def callWebProfileAnalysis(commands, ip):
    ...
    analysis.setCommand(commands.getCmd("webCmd"))
...
def callErrorAnalysis(commands, ip):
    ...
    analysis.setCommand(commands.getCmd("errorCmd"))
    analysis.setScan("")
...
def callJobAnalysis(commands, ip):
    analysis = Analysis()
    analysis.setCommand(commands.getCmd("jobCmd"))
    analysis.setScan("*")
...
def callSpiAnalysis(commands, ip):
    analysis = Analysis()
    analysis.setCommand(commands.getCmd("spiCmd"))
    analysis.setScan("*")
